  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <h1 className="font-serif text-3xl text-vintage-cream">Meine Partner</h1>
      ...
      {downline.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center bg-vintage-brown border border-vintage-sand/40" style={{ borderRadius: "var(--radius-card)" }}>
          ...
          <p className="font-serif text-lg text-vintage-cream/80">Noch keine geworbenen Partner</p>
        ...
        <>
          ...
          <section className="bg-vintage-brown border border-vintage-sand/40 p-6" style={{ borderRadius: "var(--radius-card)" }}>
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-serif text-lg text-vintage-cream">Direkt geworben (Ebene 1)</h2>
          ...
          {ebene2.length > 0 && (
            <section className="bg-vintage-brown border border-vintage-sand/40 p-6" style={{ borderRadius: "var(--radius-card)" }}>
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-serif text-lg text-vintage-cream">Indirekt (Ebene 2)</h2>
