  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <h1 className="font-serif text-3xl text-vintage-espresso">Auszahlungen</h1>
      ...
      <section className="bg-vintage-white border border-vintage-sand p-6" style={{ borderRadius: "var(--radius-card)" }}>
        <h2 className="font-serif text-lg text-vintage-espresso mb-5">Auszahlungs-Historie</h2>
            ...
            {auszahlungen.map(a => (
              <div key={a.id} className="py-3 flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  {a.referenz && <p className="text-xs text-vintage-brown font-mono mt-0.5">{a.referenz}</p>}
                </div>
              </div>
            ))}
          </div>
