    ...
    <main className="min-h-screen flex items-center justify-center bg-vintage-cream texture-paper px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-4xl text-vintage-espresso">Partner-Bereich</h1>
        ...
        <div className="bg-vintage-white border border-vintage-sand p-8" style={{ borderRadius: "var(--radius-card)", boxShadow: "var(--shadow-vintage-md)" }}>
          <h2 className="font-serif text-xl text-vintage-espresso mb-6 text-center">Anmelden</h2>
          ...
          <form action={formAction} className="space-y-5">
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-sans uppercase tracking-widest text-vintage-brown mb-1.5">Passwort</label>
            ...
            <button type="submit" disabled={isPending}
              ...
              {isPending ? <><Loader2 className="w-4 h-4 animate-spin" />Anmelden …</> : "Anmelden"}
            </button>
          </form>
        </div>
