    ...
    <main className="min-h-screen flex items-center justify-center bg-vintage-cream texture-paper px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-4xl text-vintage-espresso">{labels.mein_konto}</h1>
        ...
        <div className="bg-vintage-white border border-vintage-sand p-8" style={{ borderRadius: "var(--radius-card)", boxShadow: "var(--shadow-vintage-md)" }}>
          <h2 className="font-serif text-xl text-vintage-espresso mb-6 text-center">{labels.anmelden_titel}</h2>

          <form action={formAction} className="space-y-5">
            <div>
              <label htmlFor="email" className="block text-xs font-sans uppercase tracking-widest text-vintage-brown mb-1.5">{labels.email}</label>
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-sans uppercase tracking-widest text-vintage-brown mb-1.5">{labels.passwort}</label>
            ...
            <p className="text-center text-vintage-dust text-xs font-sans">
              <Link href="/kunde/passwort-vergessen" className="hover:text-vintage-brown underline">
                {labels.vergessen}
              </Link>
            </p>
          </form>
        ...
        <div className="text-center mt-6 space-y-2">
          <p className="text-vintage-dust text-xs font-sans">
            {labels.kein_account}{" "}
            <Link href="/kunde/registrieren" className="text-vintage-brown hover:text-vintage-espresso underline">
