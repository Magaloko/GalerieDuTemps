...
export const metadata: Metadata = { title: "Маркетинговые тексты" };
  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      >
        ...
        <span>/</span>
        <span style={{ color: "var(--color-ink)" }}>Маркетинговые тексты</span>
      </nav>
      ...
      <header>
        ...
        >
          Hero-заголовки, тикер, промо-бар и тексты рассылки — редактируются по языкам.
          Изменения появляются на сайте примерно через 60 секунд (TTL серверного кеша).
        </p>
      </header>
