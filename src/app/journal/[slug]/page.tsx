    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <nav className="mb-6 text-xs font-sans text-vintage-dust">
          <Link href="/journal" className="hover:text-vintage-cream/80 flex items-center gap-1 transition-colors w-fit">
        ...
        <article>
          <header className="mb-8">
            ...
            <h1 className="font-serif text-4xl text-vintage-cream leading-tight mb-4">{post.titel}</h1>
          ...
          {post.cover_bild_url && (
            <div className="aspect-video mb-8 overflow-hidden bg-vintage-brown/40" style={{ borderRadius: "var(--radius-card)" }}>
          ...
          <div
            className="prose max-w-none font-sans text-vintage-cream leading-relaxed
                       prose-headings:font-serif prose-headings:text-vintage-cream
                       prose-a:text-vintage-cream/80 prose-a:underline
                       prose-strong:text-vintage-cream
                       prose-blockquote:border-l-vintage-gold prose-blockquote:text-vintage-cream/80
                       prose-img:rounded"
